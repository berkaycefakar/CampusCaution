<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="flex">
      ...
      <div class="w-1/3 bg-white shadow-lg min-h-[calc(100vh-64px)] overflow-y-auto border-r">
...
export default {
  ...
  data() {
    return {
      menuOpen: false // Menü durumunu kontrol etmek için
    }
  },
 computed: {
  ...mapGetters({
  ...
  methods: {
    ...
    toggleMenu() {
      this.menuOpen = !this.menuOpen; // Menü açma/kapatma
    },
    closeModal() {
